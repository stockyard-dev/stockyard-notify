...
func(s *Server)create(w http.ResponseWriter,r *http.Request){var e store.Alert;json.NewDecoder(r.Body).Decode(&e);if e.Recipient==""{we(w,400,"recipient required");return};s.db.Create(&e);wj(w,201,s.db.Get(e.ID))}
